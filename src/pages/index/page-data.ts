...
export const data: DataType[] = [{
  ...
  list: [{
    ...
    desc: '柯克船长带领企业号继续踏上宇宙探索的旅程，他向老骨头讲述了自己对于船长身份的忧虑，而在他与最好的朋友史波克互诉衷肠前，他们又接到了一个紧急救援的任务。而神秘敌人剋劳开始攻击企业号，而幸存的企业号成员也分散至一个行星上求生。老骨头、史波克、柯克、契诃夫、乌胡拉、苏鲁等船员再次团结起来，为生存作战。但在斯科特遇见了婕拉之后，他们找到了能够征集所有船员并且逃离那座星球的方法。需要在卡尔毁掉星际舰队之前成功阻止他'
  }]
}, {
  title: '非官方',
  list: [{
