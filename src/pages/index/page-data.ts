...
export const data: DataType[] = [{
  ...
  list: [{
    ...
    name: '星际迷航 5：终极先锋',
    time: '1989 年 6 月 9 日',
    desc: '在电影开始时，进取号 A 的船员们正享受着一场悠闲的度假。新命名的进取号因为试航时表现不佳，正停靠在地球的太空港中进行整修。在约塞米蒂国家公园中，詹姆斯 · 柯克舰长面临着两个挑战：攀登埃尔凯皮顿山，以及让斯波克上校学会唱露营歌曲。不幸的是，他们的休假被一场突如其来的紧急任务打断：船员们被派遣到荒凉的尼姆巴斯 III 星上去营救被劫持的人质'
  }, {
    code: 'six',
  ...
  list: [{
    ...
    name: '星际迷航',
    time: '2009 年 5 月 8 日',
    desc: '未知的时空，无边的黑洞，一艘巨型罗慕兰战舰突然出现在太空中。崇武暴躁的罗慕兰人，是多年前离开瓦肯星人自建星际帝国的战士种族。如今，罗慕兰帝国的统治者尼诺，为了解决日后的强大劲敌斯波克，正跨越星际和时空四处搜寻他的下落。而一名为凯尔文号的联邦星舰，在追捕中不幸落入了罗慕兰的魔掌。还尚稚嫩的联邦星舰，在罗慕兰战舰催枯拉朽的火力面前反击，无异以卵击石。幸而临危受命的舰长乔治 · 柯克英勇机智，在星舰被摧毁前的短短十二分钟之内，带领全船八百余人逃出生天，这其中包括他正在分娩的妻子'
  }, {
    code: 'twelve',
    ...
    desc: '柯克船长带领企业号继续踏上宇宙探索的旅程，他向老骨头讲述了自己对于船长身份的忧虑，而在他与最好的朋友斯波克互诉衷肠前，他们又接到了一个紧急救援的任务。而神秘敌人剋劳开始攻击企业号，而幸存的企业号成员也分散至一个行星上求生。老骨头、斯波克、柯克、契诃夫、乌胡拉、苏鲁等船员再次团结起来，为生存作战。但在斯科特遇见了婕拉之后，他们找到了能够征集所有船员并且逃离那座星球的方法。需要在卡尔毁掉星际舰队之前成功阻止他'
  }]
}, {
  title: '非官方',
  list: [{
